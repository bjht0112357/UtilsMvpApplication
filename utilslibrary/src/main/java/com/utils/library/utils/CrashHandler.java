...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private void hanldeException(Throwable ex){
        ...
        if (SDCardUtils.isSDCardAvaiable() && !TextUtils.isEmpty(mLogDir)) {
    ...
    private void saveCrashInfoToFile(Throwable ex) {
        ...
        sb.append("\r\n");
        sb.append("\r\n");
        AppLogger.eRelease(sb.toString());
        FileUtils.writeToFile(mLogDir,generateLogFileName("error",time), sb.toString(), "utf-8");
        return ;
    }
    //生成日志文件名
    private String generateLogFileName(String prefix, long time){
        ...
        sb.append(prefix);
        sb.append("_");
        sb.append(DateTimeUtils.getDateStr(new Date()));
